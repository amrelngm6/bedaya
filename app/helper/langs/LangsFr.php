...
class LangsFr
{
	...
	public static function get()
	{
		...
		,'PLAYS' => 'التشغيلات'
		,'VIEWS' => 'المشاهدات'
		,'U_MY_LIKE' => 'ريما يعجبك'
		,'MORE_FROM' => 'المزيد من'
		,'PICTURE' => 'الصورة'
		,'VI_PROFILE' => 'عرض الملف الشخصي'
		,'FULL_URL' => 'الرابط بالكامل'
		,'CATEGORY' => 'القسم'
		...
		,'ABT_AUTHOR' => 'عن الكاتب'
		,'SIGNUP' => 'تسجيل'
		,'CUR_MEMBER' => 'لديك حساب بالفعل'
		,'NEW_MEMBER' => 'غير مسجل'
		,'USE_SM' => 'استخدم حساب السوشيال ميديا'
		,'SIGNUP_WITH' => 'الدخول بواسطة'
		,'PERS_INFO' => 'البيانات الشخصية'
		,'BUSS_INFO' => 'معلومات العمل'
		...
		,'CHAT' => 'محادثة'
		,'FAIL_PAY' => 'فشلت عملية الدفع'
		,'THNKS_PURCHASE' => 'شكرا لإتمام عملية الدفع'
		,'CANCL_PAY' => 'تم إلغاء عملية الدفع'
