...
heading3: {icon: '<b>H<sub>3</sub></b>',title: 'Heading 3',result: function result() {return exec(formatBlock, "<h3>\n ");}},
heading4: {icon: '<b>H<sub>4</sub></b>',title: 'Heading 4',result: function result() {return exec(formatBlock, "<h4>\n ");}},
heading5: {icon: '<b>H<sub>5</sub></b>',title: 'Heading 5',result: function result() {return exec(formatBlock, "<h5>\n ");}},
